        ...
        <div class="profil_center">
            ...
            <div class="info_docteur_">
                ...
                <div class="donner_docteur">
                    ...
                    <div class="forme" style="height: 100%;">
                        <div class="pp">
                            <div class="full_nn">Full Name : <input type="text" name="" id=""
                                    value="<?php echo $profil["nom"] . "  " . $profil["Prenom"] ?>" disabled></div>
                            <div class="date_nn"> Date of birth :<input type="date" name="" id=""
                                    value="<?php echo $profil["date_naissance"] ?>" disabled></div>
                        </div>
                        <div class="pp">
                            <div class="phone_nn">Phone no :<input type="text" name=""
                                    value="0<?php echo $profil["phone"] ?>" disabled></div>
                            <div class="sp_nn">Speciality :<input type="text" name=""
                                    value="<?php echo $profil["Specialiter"] ?>" disabled></div>
                        </div>
                        <div class="pp">
                            <div class="mail_nn">GMAIL :<input type="text" name=""
                                    value="<?php echo $profil["Gmail"] ?>" disabled></div>
                        </div>
    ...
    <div class="amin">
        <div class="popap">
            ...
            <form action="" id="form" method="POST">
                <div class="input1">
                    <div><i class='bx bx-user'></i> <input type="text" name="new_name" id=""
                            value="<?php echo $profil["nom"] . "  " . $profil["Prenom"] ?>"></div>
                    <div> <input type="date" name="new_birth" id="" value="<?php echo $profil["date_naissance"] ?>"></i>
                    </div>
                </div>
                <div class="input2">
                    <div><i class='bx bx-mobile-alt'></i> <input type="text" name="new_phone" id=""
                            value="0<?php echo $profil["phone"] ?>"></div>
                    <div> <i class='bx bx-briefcase-alt-2'></i> <input type="text" name="new_Specialiter" id=""
                            value="<?php echo $profil["Specialiter"] ?>"></div>
                </div>
                <div class="input3">
                    <div><i class='bx bxl-gmail'></i> <input type="text" name="new_Gmail" id=""
                            value="<?php echo $profil["Gmail"] ?>"></div>
