...
if (isset($_POST['brakkk'])) {
    ...
    header(("location:http://localhost/ayoub/patient/patient.php"));
}
...
<body>
                    ...
                    <tr>
                        ...
                        <td class="action_BOttonat">
                            <form action=<?php echo "patient.php?id=" . $patient["id"]  ?> action="" method="post">
                                <input type="submit" class="but1" data-id="<?= $patient["id"] ?>" name="modifier"
                                    value="update"></input>
    ...
    <div class="list">
        ...
        <table>
            ...
            <tr class="ana">
                <th><?php echo $patient["nom"] . " " . $patient["Prenom"]  ?> <i class='bx bx-chevrons-up'
